...
<template>
        ...
        <div class=" bg-gradient-to-br from-[#21334e] to-[#5c6a80] flex flex-col w-1/2 rounded-xl  m-auto my-10 p-10 justify-center items-center text-white">
            ...
            <div class="text-center w-96 ">
                    <h3 class="font-bold  text-lg">Streamline Your Technical Challenges</h3>
                    <p >
                        A centralized platform enabling seamless
                        technical support communication, allowing
                        employees to submit, track, and resolve IT issues
                        efficiently within their organization.
                    </p>
            </div>
